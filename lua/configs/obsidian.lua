...
obsidian.setup({
  ...
  attachments = {
    ...
    img_folder = "99 - Meta/01 - Attachments",  -- This is the default
...
require('which-key').add({
  ...
  {'<leader>sO', ':ObsidianSearch<cr>', desc = "[S]earch [O]bsidian by grep"},
  {'<leader>so', ':ObsidianQuickSwitch<cr>', desc = "[S]earch [O]bsidian by grep"},

  {'<leader>on', ':ObsidianNewFromTemplate<cr>', desc = "[O]bsidian [N]ew from template"},
  {'<leader>oT', ':ObsidianTOC<cr>', desc = "[O]bsidian [T]able of contents"},
  {'<leader>od', ':ObsidianDailies<cr>', desc = "[O]bsidian [D]aily notes"},
  {'<leader>oe', ':ObsidianExtractNote<cr>', desc = "[O]bsidian [E]xtract note"},
  {'<leader>oo', ':ObsidianOpen<cr>', desc = "[O]bsidian [O]pen current file"},
